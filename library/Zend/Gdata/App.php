 ...
 * Zend_Gdata_Feed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/App/Feed.php';

/**
 * Zend_Gdata_Http_Client
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Client.php';

/**
 * Zend_Version
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Version.php';

/**
 * Zend_Gdata_App_MediaSource
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/App/MediaSource.php';
...
class Zend_Gdata_App
{
    ...
    {
        require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Client/Exception.php';
        ...
        if ($body instanceof Zend_Gdata_MediaMimeStream) {
            ...
            if ($oldHttpAdapter instanceof Zend_Http_Client_Adapter_Proxy) {
                require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/HttpAdapterStreamingProxy.php';
                $newAdapter = new Zend_Gdata_HttpAdapterStreamingProxy();
            } else {
                require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/HttpAdapterStreamingSocket.php';
            ...
            foreach ($this->_registeredPackages as $name) {
                 try {
                     ...
                     if (!class_exists($name . '_' . $class, false)) {
                        require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Loader.php';
