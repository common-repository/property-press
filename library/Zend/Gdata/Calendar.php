 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Calendar/EventFeed.php';

/**
 * @see Zend_Gdata_Calendar_EventEntry
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Calendar/EventEntry.php';

/**
 * @see Zend_Gdata_Calendar_ListFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Calendar/ListFeed.php';

/**
 * @see Zend_Gdata_Calendar_ListEntry
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Calendar/ListEntry.php';
