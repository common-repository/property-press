 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Photos/UserFeed.php';

/**
 * @see Zend_Gdata_Photos_AlbumFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Photos/AlbumFeed.php';

/**
 * @see Zend_Gdata_Photos_PhotoFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Photos/PhotoFeed.php';
