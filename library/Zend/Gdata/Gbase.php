 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gbase/ItemFeed.php';

/**
 * @see Zend_Gdata_Gbase_ItemEntry
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gbase/ItemEntry.php';

/**
 * @see Zend_Gdata_Gbase_SnippetEntry
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gbase/SnippetEntry.php';

/**
 * @see Zend_Gdata_Gbase_SnippetFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gbase/SnippetFeed.php';
