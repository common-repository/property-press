 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/YouTube/UserProfileEntry.php';

/**
 * @see Zend_Gdata_YouTube_Extension_Status
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/YouTube/Extension/Status.php';
