 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/HttpClient.php';
        ...
        $accountType = 'HOSTED_OR_GOOGLE')
    {
        ...
        if ($response->getStatus() == 200) {
            ...
            if (array_key_exists('Error', $goog_resp) &&
                ...
                require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/App/CaptchaRequiredException.php';
