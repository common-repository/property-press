 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/DublinCore.php';

/**
 * @see Zend_Gdata_Books_CollectionEntry
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Books/CollectionEntry.php';

/**
 * @see Zend_Gdata_Books_CollectionFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Books/CollectionFeed.php';

/**
 * @see Zend_Gdata_Books_VolumeEntry
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Books/VolumeEntry.php';

/**
 * @see Zend_Gdata_Books_VolumeFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Books/VolumeFeed.php';
