 ...
 * @see Zend_Gdata
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata.php';

/**
 * @see Zend_Gdata_Gapps_UserFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gapps/UserFeed.php';

/**
 * @see Zend_Gdata_Gapps_NicknameFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gapps/NicknameFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gapps/EmailListFeed.php';

/**
 * @see Zend_Gdata_Gapps_EmailListRecipientFeed
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gapps/EmailListRecipientFeed.php';
...
class Zend_Gdata_Gapps extends Zend_Gdata
{
    ...
    public static function throwServiceExceptionIfDetected($e) {
        ...
        try {
            ...
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Gapps/ServiceException.php';
