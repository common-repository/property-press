...
*/
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/MimeFile.php';

/**
* @see Zend_Gdata_MimeBodyString
*/
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/MimeBodyString.php';
...
class Zend_Gdata_MediaMimeStream
{
        ...
        $fileContentType = null)
    {
        if (!file_exists($filePath) || !is_readable($filePath)) {
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/App/IOException.php';
