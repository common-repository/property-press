 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Extension/AttendeeStatus.php';

/**
 * @see Zend_Gdata_Extension_AttendeeType
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Extension/AttendeeType.php';
