 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Docs/DocumentListFeed.php';

/**
 * @see Zend_Gdata_Docs_DocumentListEntry
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Gdata/Docs/DocumentListEntry.php';
