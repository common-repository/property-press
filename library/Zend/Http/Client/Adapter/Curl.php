 ...
 * @see Zend_Uri_Http
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Uri/Http.php';
 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Client/Adapter/Stream.php';
...
class Zend_Http_Client_Adapter_Curl implements Zend_Http_Client_Adapter_Interface, Zend_Http_Client_Adapter_Stream
{
    ...
    public function __construct()
    {
        if (!extension_loaded('curl')) {
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Client/Adapter/Exception.php';
