 ...
 * @see Zend_Uri
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Uri.php';


/**
 * @see Zend_Http_Client_Adapter_Interface
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Client/Adapter/Interface.php';


/**
 * @see Zend_Http_Response
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Response.php';

/**
 * @see Zend_Http_Response_Stream
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Response/Stream.php';
...
class Zend_Http_Client
{
    ...
    public function setCookieJar($cookiejar = true)
    {
        if (! class_exists('Zend_Http_CookieJar')) {
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/CookieJar.php';
        }
    ...
    public function setCookie($cookie, $value = null)
    {
        if (! class_exists('Zend_Http_Cookie')) {
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Http/Cookie.php';
        }
