 ...
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Validate/Interface.php';
...
abstract class Zend_Validate_Abstract implements Zend_Validate_Interface
{
    ...
    public function setMessage($messageString, $messageKey = null)
    {
        ...
        if (!isset($this->_messageTemplates[$messageKey])) {
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Validate/Exception.php';
    ...
    public static function getDefaultTranslator()
    {
        if (null === self::$_defaultTranslator) {
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Registry.php';
