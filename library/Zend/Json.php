 ...
 * @see Zend_Json_Expr
 */
require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Json/Expr.php';
...
class Zend_Json
{
    ...
    public static function decode($encodedValue, $objectDecodeType = Zend_Json::TYPE_ARRAY)
    {
        ...
        if (function_exists('json_decode') && self::$useBuiltinEncoderDecoder !== true) {
            ...
            if (!function_exists('json_last_error')) {
                if ($decode === $encodedValue) {
                    require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Json/Exception.php';
        ...
        require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Json/Decoder.php';
    ...
    public static function encode($valueToEncode, $cycleCheck = false, $options = array())
    {
        ...
        if (function_exists('json_encode') && self::$useBuiltinEncoderDecoder !== true) {
            ...
            require_once WP_PLUGIN_DIR.'/property-press/library/Zend/Json/Encoder.php';
